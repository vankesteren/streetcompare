...
ongevallen_2011_2020_joined <- ongevallen_2011_2020 %>%
  ...
  dplyr::select(VKL_NUMMER, JAAR_VKL, GME_ID, GME_NAAM, X_COORD, Y_COORD, geometry, ANTL_PTJ, OTE_OMS, AP3_OMS, AOL_OMS, NIVEAUKOP)

# Filter gemeente utrecht
ongevallen_2011_2020_joined <- ongevallen_2011_2020_joined %>%
  filter(GME_NAAM == "Utrecht")

# Write new file 2011-2020
st_write(ongevallen_2011_2020_joined, "data/output/ongevallen_parsed_2011_2020.shp")
st_write(ongevallen_2011_2020_joined, "data/output/ongevallen_parsed_2011_2020.geojson")
save(ongevallen_2011_2020_joined, file = "data/output/ongevallen_parsed_2011_2020.RData")
...
# GME_ID - Unieke identificatie van de gemeente waarin conform de in het BN actuele gemeentegrenzen het verkeersongeval heeft plaatsgevonden
# GME_NAAM -	Naam van de gemeente waarin conform de in het BN actuele gemeentegrenzen het verkeersongeval heeft plaatsgevonden
...
# # Filter Einsteindreef of Utrecht?
ongevallen_2017_2020 <- ongevallen_2017_2020 %>%
  filter(GME_NAAM == "Utrecht")
